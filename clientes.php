...
<body>
    ...
    <a href="cadastrar_cliente.php">Cadastrar</a> <br>
    ...
    <table border="1" cellpadding="10">
        ...
        <?php
            ...
            while($cliente = $query_clientes->fetch_assoc()){
                ...
                // Formatando o telefone usando (substr) — Retorna uma parte de uma string
            ...
            if(!empty($cliente['nascimento'])){
                $nascimento = 
                implode('/', array_reverse(explode('-', $cliente['nascimento'])));
            }
